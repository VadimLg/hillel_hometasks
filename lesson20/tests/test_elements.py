...
from lesson20.DynamicPropertiesPage import PageDynamicProperties
from lesson20.ElementsPage import ElementsPage

class TestElementsPage:
    def test_page_chrome(self, chrome):
        page = ElementsPage(chrome)
        page.open()
        elements = page.get_elements_page_categories()
        assert len(elements) == 33

    def test_page_firefox(self, firefox):
